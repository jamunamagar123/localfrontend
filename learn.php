...
<head>
  ...
  <style>
    ...
    #map-box { height:300px; border-radius:8px; border:1px solid #e6e9ed; overflow:hidden; margin-top:8px; }
...
<body>
  <div class="container">
    <div class="hero" style="background-image:url('pokara.jpg')"></div>

    <div class="card">
      <div class="left">
        <h2>Fewa Lake</h2>
        <div class="thumbs">
          <img src="pokara.jpg" alt="Lake view">
          <img src="boting.jpg" alt="Boating">
          <img src="mount.jpg" alt="Mountains">
        </div>

        <div style="margin-top:12px; border-top:1px solid #e6e9ed; padding-top:12px;">
          <div class="location-title">Location</div>
          <div style="color:#888; margin-bottom:8px;">Lakeside, Pokhara, Nepal
      ...
      <div class="right">
        <h3>Experience Fewa Lake</h3>
        <p>Fewa Lake is the heart of Pokhara, offering boat rides, waterfront cafes, and reflections of the Annapurna range.</p>
  ...
  <script>
    // Map
    const map = L.map('map-box').setView([28.2110, 83.9580], 15);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { attribution: '&copy; OpenStreetMap contributors' }).addTo(map);
    L.marker([28.2110, 83.9580]).addTo(map).bindPopup("<b>Fewa Lake</b><br>Lakeside, Pokhara").openPopup();
